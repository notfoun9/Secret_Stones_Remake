...
bool CardCondition(const std::vector<int>& field) = delete;

template<>
bool CardCondition<1, 0>(const std::vector<int>& field) {
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 1>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 2>(const std::vector<int>& field)
{
...
template<>
bool CardCondition<1, 3>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<1, 4>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 5>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 6>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 7>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 8>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 9>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4}) {
...
template<>
bool CardCondition<1, 10>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 11>(const std::vector<int>& field)
{
    return field[4] == ORANGE;
}

template<>
bool CardCondition<1, 12>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<1, 13>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<1, 14>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<1, 15>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<1, 16>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<1, 17>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 18>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<1, 19>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<1, 20>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 21>(const std::vector<int>& field)
{
    return field[4] == RED;
}

template<>
bool CardCondition<1, 22>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<1, 23>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 24>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<1, 25>(const std::vector<int>& field)
{
    for (int i : {1,2,4,5}) {
...
template<>
bool CardCondition<1, 26>(const std::vector<int>& field)
{
    for (int i = 0; i < 6; ++i) {
...
template<>
bool CardCondition<1, 27>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<2, 0>(const std::vector<int>& field)
{
    return field[8] == BLACK;
}

template<>
bool CardCondition<2, 1>(const std::vector<int>& field)
{
    for (int i : {6,7,8}) {
...
template<>
bool CardCondition<2, 2>(const std::vector<int>& field)
{
    return (field[0] == GREEN && field[8] == ORANGE);
}

template<>
bool CardCondition<2, 3>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<2, 4>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<2, 5>(const std::vector<int>& field)
{
    for (int i : {0,1,2}) {
...
template<>
bool CardCondition<2, 6>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4,6,7}) {
...
template<>
bool CardCondition<2, 7>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4}) {
...
template<>
bool CardCondition<2, 8>(const std::vector<int>& field)
{
    return field[0] == YELLOW;
}

template<>
bool CardCondition<2, 9>(const std::vector<int>& field)
{
    return (field[0] == PURPLE && field[8] == PURPLE);
}

template<>
bool CardCondition<2, 10>(const std::vector<int>& field)
{
    return (field[2] == WHITE && field[6] == WHITE);
}

template<>
bool CardCondition<2, 11>(const std::vector<int>& field)
{
    return (field[2] == RED && field[6] == BLUE);
}

template<>
bool CardCondition<2, 12>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<2, 13>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<2, 14>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<2, 15>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<2, 16>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<2, 17>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<2, 18>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<2, 19>(const std::vector<int>& field)
{
    for (int i : {0,1,2}) {
...
template<>
bool CardCondition<3, 0>(const std::vector<int>& field)
{
    return (field[1] == WHITE && field[6] == WHITE && field[8] == WHITE);
}

template<>
bool CardCondition<3, 1>(const std::vector<int>& field)
{
    for (int i : {0,1,2}) {
...
template<>
bool CardCondition<3, 2>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<3, 3>(const std::vector<int>& field)
{
    for (int i : {0,1,2}) {
...
template<>
bool CardCondition<3, 4>(const std::vector<int>& field)
{
    for (int i : {0,1,2}) {
...
template<>
bool CardCondition<3, 5>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4}) {
...
template<>
bool CardCondition<3, 6>(const std::vector<int>& field)
{
    for (int i : {0,1,2}) {
...
template<>
bool CardCondition<3, 7>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<3, 8>(const std::vector<int>& field)
{
    return (field[0] == BLUE && field[2] == BLUE && field[7] == BLUE);
}

template<>
bool CardCondition<3, 9>(const std::vector<int>& field)
{
    for (int i : {0,1,3,4}) {
...
template<>
bool CardCondition<3, 10>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<3, 11>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<3, 12>(const std::vector<int>& field)
{
    for (int i : {0,3,6}) {
...
template<>
bool CardCondition<5, 0>(const std::vector<int>& field)
{
    return (field[1] == GREEN && field[3] == ORANGE && field[5] == ORANGE && field[7] == BLUE);
}

template<>
bool CardCondition<5, 1>(const std::vector<int>& field)
{
    return (field[1] == YELLOW && field[6] == RED && field[8] == RED);
}

template<>
bool CardCondition<5, 2>(const std::vector<int>& field)
{
    return (field[1] == WHITE && field[3] == PURPLE && field[5] == PURPLE && field[7] == BLACK);
}

template<>
bool CardCondition<5, 3>(const std::vector<int>& field)
{
    return (field[0] == PURPLE && field[2] == GREEN && field[6] == WHITE && field[8] == BLUE);
}

template<>
bool CardCondition<5, 4>(const std::vector<int>& field)
{
    return (field[0] == BLACK && field[4] == ORANGE && field[8] == ORANGE);
}

const std::vector<bool(*)(const std::vector<int>&)> cardConditions1
{
...
const std::vector<bool(*)(const std::vector<int>&)> cardConditions2
{
...
const std::vector<bool(*)(const std::vector<int>&)> cardConditions3
{
...
const std::vector<bool(*)(const std::vector<int>&)> cardConditions5
{
